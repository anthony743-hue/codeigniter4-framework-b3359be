...
INSERT INTO livre (isbn, titre, auteur, categorie_id, date_publication, resume, status_id) VALUES 
...
-- ============================================================================
-- INSERTION DES EMPRUNT
-- ============================================================================
-- 1. Un emprunt déjà rendu (Livre 1 par Utilisateur 1)
INSERT INTO emprunt (livre_id, utilisateur_id, date_emprunt, date_retour, date_retour_prevu, notes) 
...
INSERT INTO emprunt (livre_id, utilisateur_id, date_emprunt, date_retour_prevu) 
